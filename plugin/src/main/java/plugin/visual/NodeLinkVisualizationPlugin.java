 ...
 * Each node represents an instance of data.
 * the edge is color coded. 
 * The color from red to green to blue means the strength of the connection
 * goes from strong (1.0) to weak (close to 0.0)
 * Two donuts plots at the bottom are plotting the connection each node has 
 * in terms of connection strength or number of connections
 * The node link graph is generated by graphstream module
 * The donut plots are generated by XCharts
 */
...
//                n1.setAttribute("layout.weight",2.0);
    ...
    private JPanel getStrengthDonutPanel(RelationshipData relationshipData, AnalysisData analysisData) {
        ...
        // part of code cited from XCharts demo code
